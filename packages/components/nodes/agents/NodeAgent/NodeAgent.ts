...
class NodeAgent_Agents implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor(fields?: { sessionId?: string }) {
        ...
        this.description = `Node Agent that can be used in a Graph Agent. Similar to Tool Agent`
...
module.exports = { nodeClass: NodeAgent_Agents }
